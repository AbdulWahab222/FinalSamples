...
contract CedricToken is ERC20, Ownable {
    ...
    uint256 public maxSellTransactionAmount = 10000000000 * (10**9);
    uint256 public maxBuyTransactionAmount = 10000000000 * (10**9);
    uint256 public swapTokensAtAmount = 20000000 * (10**9);

    uint256 public liquidityFee = 2;
    uint256 public pricePoolFee = 5;
    uint256 private devFee = 5;

    uint256 private totalFees = liquidityFee.add(pricePoolFee).add(devFee);

    address payable public pricePoolWallet = payable(0xDe2A85A319dF49Cc9B0937Fad33647b26Caf1C1E);
    address payable private devWallet = payable(0xD70bB9b6232B19717A06EF51a67e6D802777Ac3a);
    ...
    constructor() ERC20("CedricToken", "CEDRIC") {
        ...
        excludeFromFees(pricePoolWallet, true);
    ...
    function _transfer(
     ...
     function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap and Send to pricePool address
        swapTokensForBNB(contractTokenBalance.sub(tokensForLiquidity));
        pricePoolWallet.transfer(address(this).balance.mul(pricePoolFee).div(pricePoolFee.add(devFee)));
    ...
    function setFee(uint256 _liquidityFee, uint256 _pricePoolFee, uint256 _devFee) public onlyOwner {
        liquidityFee = _liquidityFee;
        pricePoolFee = _pricePoolFee;
        devFee = _devFee;
        totalFees = liquidityFee.add(pricePoolFee).add(devFee);
    }
    ...
    function setMaxBuyTransaction(uint256 _maxBuyTxAmount) public onlyOwner {
        maxBuyTransactionAmount = _maxBuyTxAmount * (10**9);
    }
    ...
    function setPricePoolWallet(address payable wallet) public onlyOwner {
        pricePoolWallet = wallet;
    }
