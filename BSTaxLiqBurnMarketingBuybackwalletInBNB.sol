...
contract JLB is Context, IERC20, Ownable {
    ...
    string private _name = "Jalebi Coin";
    string private _symbol = "JLB";
    uint8 private _decimals = 9;
    
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x1D00bfa747F76B2E1bbb2ed585dF6d7978a5ad78;
    address payable public buyBackWallet = payable(0xE901a72F4E716774064eAFE8EcD66b0f33f0048d);
    ...
    uint256 public _saleBuyBackFee = 5;
    ...
    uint256 public minimumTokensBeforeSwap = 500000000000 * 10**9;
    uint256 public _maxBuyTxAmount = 100000000000000 * 10**9;
    uint256 public _maxSellTxAmount = 100000000000000 * 10**9;
    uint256 public maxWalletToken = 100000000000000 * (10**9);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 liquidityTokenShare = contractTokenBalance.mul(_liquidityFee).div(_saleLiquidityFee.add(_saleBuyBackFee));
        uint256 buybackTokenShare = contractTokenBalance.sub(liquidityTokenShare);
        ...
        swapTokensForEth(buybackTokenShare, buyBackWallet);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private 
    {
        ...
        {
            setAllFees(_saleTaxFee, _saleLiquidityFee, _saleMarketingFee, _saleBurnFee, _saleBuyBackFee);
        }
    ...
    function setAllFees(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 burnFee, uint256 buyBackFee) private {
        _taxFee = taxFee;
    ...
    function setFees(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 burnFee, uint256 buyBackFee) 
    external onlyOwner() {
        setAllFees(taxFee, liquidityFee, marketingFee, burnFee, buyBackFee);
    ...
    function setSaleFees(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 burnFee, uint256 buyBackFee) 
    external onlyOwner() {
        _saleTaxFee = taxFee;
