//https://bscscan.com/address/0x5cc4f4b88a5ab06f2eaaa5830a81befab5d4bfa9#code
...
contract PepperMintShiba is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000000000000000 * (10**9);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "PepperMint Shiba";
    string private _symbol = "PEPPERMINT";
    ...
    address public charityWallet = 0x5248654792be5608c72D1c1Afd1f12afB39E11fC;
    ...
    constructor() {
        _rOwned[0x20bc82010B7C1e9446cD9126Bc9fB18429ce960E] = _rTotal;
        ...
        emit Transfer(address(0), 0x20bc82010B7C1e9446cD9126Bc9fB18429ce960E, _tTotal);
    }
    ...
    function includeInFee(address account) public onlyOwner {
     ...
     function setFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 charityFee, uint256 burnFee) external onlyOwner() {
        _taxFee = taxFee;
    ...
    function setNumTokensSellToAddToLiquidity(uint256 newAmount) external onlyOwner() {
        numTokensSellToAddToLiquidity = newAmount*10**9;
    }
