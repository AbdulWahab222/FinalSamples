// acct 2 
//metagirlnft
// Caped supply , only marketing fee
// https://bscscan.com/address/0x1f40c4121ea7946f85a890699421a41ded7a091f
...
contract FMEV2 is ERC20Capped, ERC20Mintable, ERC20Burnable, Ownable {
    using SafeMath for uint256;
    ...
    address public  marketingWallet = 0xf6596b74De97a5d06D6CEb3aFFF37A38ADfdF853;

    uint256 public _maxTxAmount = 155555555555 * 10**9;
    ...
    constructor() ERC20("Fantasy Girl", "FMEV2")
                    ERC20Capped(155555555555*10**9)  {
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "FMEV2: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "FMEV2: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "FMEV2: Automated market maker pair is already set to that value");
    ...
    function _transfer(
        ...
        if(_isExcludedFromFees[from] && _isExcludedFromFees[to]) {
            require(amount <= _maxTxAmount, "Transaction amount must be less than equal to max transaction amount");
        }
    ...
    function swapTokensForBUSD(uint256 tokenAmount) private lockTheSwap {
        ...
        path[2] = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // BUSD cotract address
    ...
    function setSwapTokensAtAmount(uint256 newAmt) external onlyOwner() {
        _swapTokensAtAmount = newAmt * (10**9);
    }
    ...
    function setSellTax(uint256 _marketingSellFee) external onlyOwner() {
        require(_marketingSellFee <= 15, "Sell tax must be less than or equal to 15");
