...
contract Vestacoin is Context, IERC20, Ownable {
    ...
    string private _name = "Vestacoin";
    string private _symbol = "VESTA";
    uint8 private _decimals = 9;
    
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xbD11BB098b84d392D994C676E114cFE278E90eb5;
    ...
    uint256 public _saleLiquidityFee = 7;
    ...
    uint256 public minimumTokensBeforeSwap = 10000000 * 10**9;
    uint256 public _maxBuyTxAmount = 2000000000 * 10**9;
    uint256 public _maxSellTxAmount = 2000000000 * 10**9;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 marketingTokenShare = contractTokenBalance.mul(_marketingFee).div(_saleLiquidityFee);
        // swap and send to marketing
        swapTokensForBUSD(marketingTokenShare);

        // Liquidity tokenShare
        uint256 liquidityTokenShare = contractTokenBalance.sub(marketingTokenShare);
     ...
     function swapTokensForBUSD(uint256 tokenAmount) private {
        ...
        path[2] = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;//0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // BUSD cotract address
    ...
    function setFees(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee) 
    external onlyOwner() {
